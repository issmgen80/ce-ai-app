 ...
 */
const scanJatoDatabase = (jatoFilters) => {
 ...
 */
const validateScanFilters = (jatoFilters) => {
  const errors = [];
 ...
 */
const getNoMatchesMessage = (jatoFilters) => {
  const { budgetFilter, useCaseFilter, bodyTypeFilter, fuelTypeFilter } =
    jatoFilters;
